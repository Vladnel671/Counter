...
const SettingsWrapper2: FC<SettingsWrapperTypeProps> = ({
                                                           buttonStates,
    ...
    return (
        <div className='settingsMain'>
            ...
            <div className='btnWrap'>
                <Button2 onClickHandler={setMinMaxValues} buttonStateDisable={buttonStates[0]} className='setButton'
                         nameButton='Set'/>
            </div>
        </div>
    );
...
export default SettingsWrapper2;